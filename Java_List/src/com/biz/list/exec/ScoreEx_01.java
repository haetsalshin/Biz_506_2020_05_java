...
public class ScoreEx_01 {
	...
	public static void main(String[] args) {
		...
		// 4. 리스트에 추가
		scoreList.add(scoreVO); // size() 1인 리스트에 값이 저장 된 인스턴스 추가

		// 새로운 인스턴스를 추가 할 때
		// 5. 선언되어 있는 인스턴스를 반드시 다시 초기화를 해야 한다.
		
		scoreVO = new ScoreVO(); // 초기화 안하고 set 하면 호출되는 모든 값이 001의 배열과 같은 값으로 001,91,86,100이 세번 반복되어 출력된다.꼭해줘야함 
		scoreVO.setNum("002");
		scoreVO.setKor(99);
		scoreVO.setEng(88);
		scoreVO.setMath(77);
