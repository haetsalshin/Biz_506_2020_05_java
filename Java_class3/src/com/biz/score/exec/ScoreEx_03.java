...
public class ScoreEx_03 {
	...
	public static void main(String[] args) {
		...
		int[] num = new int[3]; // 일반적인 배열
		/*
		 *  선언을 할 때는 List를 사용해서 선언하고
		...
		// List type의 인스턴스, List type의 객체, str1 리스트 라고 칭한다.
		// String형 데이터 들을 포함 할 리스트
		// size가 0인 String형 데이터들을 포함 할 리스트를 생성하는 명령문
		List<String> str1= new ArrayList<String>(); // size = 0인 List가 하나 만들어짐.
		...
		// java 1.8 이상에서는
		// 초기화 코드(New ArrayList)에는 Generic을 생략 할 수 있다.
		...
		// 포함 할 수 있는 리스트
		List<Random> rndList = new ArrayList<>();
