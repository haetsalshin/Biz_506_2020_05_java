...
public class ScanEx_06 {
	public static void main(String[] args) {
		...
		System.out.println(""+3+4); // 34, 숫자를 문자열로 형변환 해주는 방법.. 가장 쉽당
