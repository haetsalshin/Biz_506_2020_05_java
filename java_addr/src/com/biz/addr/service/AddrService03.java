...
public class AddrService03 {
	...
	public AddrService03() {
		...
		scan = new Scanner(System.in); // 2번째 초기화방법
	}

	/*
	 * 현재 코드는 main 에서 지정된 for반복문의 개수만큼 입력을 수행해야 한다.
	 * 만약 입력하는 도중 입력을 중단하고 싶을 때 중단할 수 있도록 코드를 개선하자.
	 * 
	 * 입력하는 도중 이름대신 END 문자열을 입력하면 입력을 중단한다.
	 */
	...
	public boolean inputAddr() {
		...
		// 만약 이름을 입력할 때 문자열 END를 입력하면 더이상 진행하지 말고
		// false return하고 method를 중단하라
		//if(strName == "END") {
			//return false;
		//}
