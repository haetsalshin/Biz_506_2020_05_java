...
public class ClassEx_02 {
	public static void main(String[] args) {
		...
		// main() method내에서 변수처럼 선언하고, 생성을 해주어야 한다.
		// 이 때 클래스를 사용해서 만든 변수를
		//          객체(object), 인스턴스 라고 한다.
		...
		// 인스턴스 통해서 변수에 접근 할 수 없다.
		
		// 멤버변수에 접근제한자를 붙이지 않으면 클래스가 저장된 패키지에 따라서 
