...
public class Grade_08 {
	...
	public static void main(String[] args) {
		...
		/*
		 * intKorScore배열을 10개 생성하여 각 변수에 점수를 저장하려고 명령을 수행하는 과정에서
		 * 
		 * ArrayIndexoutOfBoundException 이 발생을 한다.
		 * 
		 * 그 이유는 intKorScore 배열은 10개만 생성되어
		 * 실제 index 값은 0 ~ 9 까지만 사용할 수 있다.
		 * 그런데 10번 index에 앖을 저장하려고 명령을 수행했기 때문에
		 * Exception이 발생한 것이다.
		 */
