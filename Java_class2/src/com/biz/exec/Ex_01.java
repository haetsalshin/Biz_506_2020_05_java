...
public class Ex_01 {
	...
	// ^11를 사용해서 프로젝트를 Run 하려면 main() method 필요
	public static void main(String[] args) {
		...
		address3.setName("이몽룡");
		
		address1.setAddr("광주광역시 북구");
		address2.setAddr("광주광역시 서구");
		address3.setAddr("광주광역시 광산구");
		...
		// address* d인스턴스에 저장된 주소들을 
		// 별도의 문자열 변수에복사하여 Console에 출력
