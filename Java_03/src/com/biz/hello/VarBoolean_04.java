...
public class VarBoolean_04 {
	...
	public static void main(String[] args) {
		 ...
		 * 
		 * 변수는 선언을 한 후 최소한 1번은 값을 저장해줘야만  읽을 수가 있다. 이러한 것을 변수가 사용가능하다 라고 한다.
		 * 사용가능하다 = 저장, 읽기가 모두 가능한 상태.
		 * 
		 * 또한 변수를 선언한 후 어떠한 값을 저장하는 것을 변수를 초기화 한다라고 한다.
		 * 변수는 초기화가 되어야만 사용(읽기, 쓰기)가 가능하다.
		 * 
		 * 변수는 기본적으로 제공되는 int, float, long, double, boolean, character 들은
		 ...
		 * 
		 * JDK에서 import 한 키워드로 생성(선언, 초기화)한 변수는 하는 일이 조금 다르다.
		 ...
		 * 
		 * .nextInt(100) method를  연결하면 이 명령문은 0부터 99까지의 임의의 정수를 만들어 num1 변수에 저장한다.
		 * 
		 */
		num1 = rnd.nextInt(5); // 0부터 (숫자)-1까지 
